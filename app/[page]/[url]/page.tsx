...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: "Discover how various eye symptoms are diagnosed and what they might indicate.",
  };
}
  ...
  return (
    <main className="px-4 lg:px-20">
      ...
      <div className="mt-12">
        ...
        <p>Diagnosis of eye conditions involves a comprehensive examination and evaluation by an ophthalmologist. Tests may include:</p>
        ...
        <p className="mt-4">Based on the symptoms and test results, an accurate diagnosis can be made to determine the appropriate treatment.</p>
      </div>

      <div className="mt-12">
        <SubTitle title1="Eye Symptoms" title2="" description="" />
        <p>This list of symptoms and possible eye problems is for general reference only and is not intended to diagnose any specific eye disease or condition. Online symptom checkers can't cover all visual symptoms or all possible related conditions. Eye injuries, sudden changes to—or loss of—vision and eye pain can be signs of serious problems, requiring emergency attention. If you have any eye or vision symptoms, talk to your ophthalmologist. Always consult a doctor about your own health and seek treatment if you have any worries about your eyes or vision.</p>
        <div className="mt-6">
          <Image
